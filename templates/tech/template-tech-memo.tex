...
\input{templates/tech/template-tech-format}
...
\AtBeginDocument{
   ...
   \begin{minipage}{.22\textwidth}
      \begin{flushleft}
      \ifdefstring{\@docOrgLogo}{}{}{\includegraphics[height=0.5in]{\@docOrgLogo}}
      \end{flushleft}
   \end{minipage}%
   ...
   \begin{minipage}{.22\textwidth}
      \begin{flushright}
         \ifdefstring{\@docLogo}{}{}{\includegraphics[height=.7in]{\@docLogo}}
      \end{flushright}
   \end{minipage}
